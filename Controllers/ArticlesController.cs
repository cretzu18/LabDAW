...
public class ArticlesController : Controller
{
    ...
    {
        int pageSize = 5; // Page size implicit conform cerinței

        // Cerem datele de la Service
        var totalItems = await _articleService.CountAsync(categoryId, ct);
        var articles = await _articleService.GetPagedAsync(page, pageSize, categoryId, ct);
    ...
    private async Task LoadDropdownsAsync(dynamic viewModel, CancellationToken cancellationToken)
    {
